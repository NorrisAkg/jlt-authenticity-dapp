        ...
        <div class="row g-5">
              ...
              <div class="pd-tab-inner">
                ...
                >
                  <button
                    ...
                    v-for="(thumbnailSm, index) in product.thumbnailImages"
                ...
                <div class="tab-content rn-pd-content" id="v-pills-tabContent">
                  <div
                    ...
                    v-for="(thumbnailLg, index) in product.thumbnailImages"
          ...
          <div class="col-lg-5 col-md-12 col-sm-12 mt_md--50 mt_sm--60">
            <div class="rn-pd-content-area">
              ...
              <router-link class="btn btn-primary-alta" to="#"
                >Unlockable content included</router-link
              >
                        ...
                        <div class="top-seller-wrapper">
                          <div class="thumbnail">
                            <router-link to="#"
                              ><img
                                :src="
                                  require(`@/assets/images/client/client-3.png`)
                                "
                                alt="Nft_Profile"
                            /></router-link>
                          </div>
                        ...
                        <div class="top-seller-wrapper">
                          <div class="thumbnail">
                            <router-link to="#"
                              ><img
                                :src="
                                  require(`@/assets/images/client/client-4.png`)
                                "
                                alt="Nft_Profile"
                            /></router-link>
                          </div>
                          <div class="top-seller-content">
                            <span
                              >0.09wETH by
                              <router-link to="#">Joe Biden</router-link></span
                            >
                        ...
                        <div class="top-seller-wrapper">
                          <div class="thumbnail">
                            <router-link to="#">
                              <img
                                :src="
                                  require(`@/assets/images/client/client-5.png`)
                                "
                                alt="Nft_Profile"
                              />
                            </router-link>
                        ...
                        <div class="top-seller-wrapper">
                          <div class="thumbnail">
                            <router-link to="#"
                              ><img
                                :src="
                                  require(`@/assets/images/client/client-6.png`)
                                "
                                alt="Nft_Profile"
                            /></router-link>
                          </div>
                        ...
                        <div class="top-seller-wrapper">
                          <div class="thumbnail">
                            <router-link to="#">
                              <img
                                :src="
                                  require(`@/assets/images/client/client-7.png`)
                                "
                                alt="Nft_Profile"
                              />
                            </router-link>
                        ...
                        <div class="top-seller-wrapper">
                          <div class="thumbnail">
                            <router-link to="#">
                              <img
                                :src="
                                  require(`@/assets/images/client/client-8.png`)
                                "
                                alt="Nft_Profile"
                              />
                            </router-link>
                        ...
                        <div class="top-seller-wrapper">
                          ...
                          <div class="top-seller-content">
                            <span class="heighest-bid"
                              >Heighest bid
                              <router-link to="#">Atif aslam</router-link></span
                            >
